App.info({
  id: 'com.evart',
  name: 'Evart',
  description: 'Evart Social Network',
  author: 'Taras Labiak',
...
App.icons({
  ...
  ipad: 'client/images/logo.png',
  ipad_2x: 'client/images/logo.png',
  ipad_pro: 'client/images/logo.png',
  ios_settings: 'client/images/logo.png',
  ios_settings_2x: 'client/images/logo.png',
  ios_settings_3x: 'client/images/logo.png',
  ios_spotlight: 'client/images/logo.png',
  ios_spotlight_2x: 'client/images/logo.png',
  android_mdpi: 'client/images/logo.png',
  android_hdpi: 'client/images/logo.png',
  android_xhdpi: 'client/images/logo.png',
  android_xxhdpi: 'client/images/logo.png',
  android_xxxhdpi: 'client/images/logo.png'
})
